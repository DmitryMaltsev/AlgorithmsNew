...
public partial class ChooseModePage : ContentPage
{
    ...
    {
        _chooseModeViewModel.CPictureSet.SelectModesPics[1].Current = _chooseModeViewModel.CPictureSet.SelectModesPics[1].Selected;
    }
    private void Min_Released(object sender, EventArgs e)
    {
        _chooseModeViewModel.CPictureSet.SelectModesPics[1].Current = _chooseModeViewModel.CPictureSet.SelectModesPics[1].Default;
    }

    private void Norm_Pressed(object sender, EventArgs e)
    {
        _chooseModeViewModel.CPictureSet.SelectModesPics[2].Current = _chooseModeViewModel.CPictureSet.SelectModesPics[2].Selected;
    }
    private void Norm_Released(object sender, EventArgs e)
    {
        _chooseModeViewModel.CPictureSet.SelectModesPics[2].Current = _chooseModeViewModel.CPictureSet.SelectModesPics[2].Default;
    }

    private void Max_Pressed(object sender, EventArgs e)
    {
        _chooseModeViewModel.CPictureSet.SelectModesPics[3].Current = _chooseModeViewModel.CPictureSet.SelectModesPics[3].Selected;
    }
    private void Max_Released(object sender, EventArgs e)
    {
        _chooseModeViewModel.CPictureSet.SelectModesPics[3].Current = _chooseModeViewModel.CPictureSet.SelectModesPics[3].Default;
    }

    private void Kitchen_Pressed(object sender, EventArgs e)
    {
        _chooseModeViewModel.CPictureSet.SelectModesPics[4].Current = _chooseModeViewModel.CPictureSet.SelectModesPics[4].Selected;
    }
    private void Kitchen_Released(object sender, EventArgs e)
    {
        _chooseModeViewModel.CPictureSet.SelectModesPics[4].Current = _chooseModeViewModel.CPictureSet.SelectModesPics[4].Default;
    }

    private void Vac_Pressed(object sender, EventArgs e)
    {
        _chooseModeViewModel.CPictureSet.SelectModesPics[5].Current = _chooseModeViewModel.CPictureSet.SelectModesPics[5].Selected;
    }
    private void Vac_Released(object sender, EventArgs e)
    {
        _chooseModeViewModel.CPictureSet.SelectModesPics[5].Current = _chooseModeViewModel.CPictureSet.SelectModesPics[5].Default;
    }

    private void Shed_Pressed(object sender, EventArgs e)
    {
        _chooseModeViewModel.CPictureSet.SelectModesPics[6].Current = _chooseModeViewModel.CPictureSet.SelectModesPics[6].Selected;
    }
    private void Shed_Released(object sender, EventArgs e)
    {
        _chooseModeViewModel.CPictureSet.SelectModesPics[6].Current = _chooseModeViewModel.CPictureSet.SelectModesPics[6].Default;
    }

    private void TurnOff_Pressed(object sender, EventArgs e)
    {
        _chooseModeViewModel.CPictureSet.SelectModesPics[0].Current = _chooseModeViewModel.CPictureSet.SelectModesPics[0].Selected;
    }
    private void TurnOff_Released(object sender, EventArgs e)
    {
        _chooseModeViewModel.CPictureSet.SelectModesPics[0].Current = _chooseModeViewModel.CPictureSet.SelectModesPics[0].Default;
    }
