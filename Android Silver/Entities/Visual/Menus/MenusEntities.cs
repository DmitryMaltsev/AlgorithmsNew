...
namespace Android_Silver.Entities.Visual.Menus
{
    public class MenusEntities : BindableBase
    {
        ...
        public MenusEntities()
        {
            ...
            ETH_CALIBRATE_THM_LENGTH = 34;
            ETH_TCONST_THM_ADDR = ETH_CALIBRATE_THM_ADDR + ETH_CALIBRATE_THM_LENGTH;
            ...
            #region Пункты меню 
            MItem mItem = new MItem("Конфигурация", isVisible: true, _pictureSet.BaseSettings1ButCollection[0], SActivePageState.ConfigPage, id: 1, startAddress: ETH_CONFIG_SETTINGS_ADDR);
            StartMenuCollection.Add(mItem);
            mItem = new MItem("Общие", isVisible: true, _pictureSet.BaseSettings1ButCollection[1], SActivePageState.CommonSettingsPage, id: 2, startAddress: ETH_COMMON_SETTINGS_ADDR);
            StartMenuCollection.Add(mItem);
            mItem = new MItem("Жалюзи", isVisible: true, _pictureSet.BaseSettings1ButCollection[2], SActivePageState.DamperSettingsPage, id: 3, startAddress: ETH_DAMPER_SETTINGS_ADDR);
            StartMenuCollection.Add(mItem);
            mItem = new MItem("Вентилятор", isVisible: true, _pictureSet.BaseSettings1ButCollection[3], SActivePageState.FanSettingsPage, id: 4, startAddress: ETH_FAN_SETTINGS_ADDR);
            StartMenuCollection.Add(mItem);
            mItem = new MItem("Нагреватель водяной", isVisible: true, _pictureSet.BaseSettings1ButCollection[4], SActivePageState.WHSettingsPage, id: 5, startAddress: ETH_WH_SETTINGS_ADDR);
            StartMenuCollection.Add(mItem);
            mItem = new MItem("Нагреватель электрический", isVisible: true, _pictureSet.BaseSettings1ButCollection[5], SActivePageState.EHSettingsPage, id: 6, startAddress: ETH_EH_SETTINGS_ADDR);
            StartMenuCollection.Add(mItem);
            mItem = new MItem("Охладитель фреоновый", isVisible: true, _pictureSet.BaseSettings1ButCollection[6], SActivePageState.FreonSettingsPage, id: 7, startAddress: ETH_FREON_SETTINGS_ADDR);
            StartMenuCollection.Add(mItem);
            mItem = new MItem("Рекуператор", isVisible: true, _pictureSet.BaseSettings1ButCollection[7], SActivePageState.RecupSettingsPage, id: 8, startAddress: ETH_RECUP_SETTINGS_ADDR);
            StartMenuCollection.Add(mItem);
            mItem = new MItem("Увлажнитель", isVisible: true, _pictureSet.BaseSettings1ButCollection[8], SActivePageState.HumSettingsPage, id: 9, startAddress: ETH_HUM_SETTINGS_ADDR);
            StartMenuCollection.Add(mItem);
            mItem = new MItem("Настройка аналоговых датчиков", isVisible: true, _pictureSet.BaseSettings1ButCollection[9], SActivePageState.SensorsSettingPage, id: 10, startAddress: ETH_SENS_SETTINGS_ADDR);
            StartMenuCollection.Add(mItem);
            mItem = new MItem("Настройка термоанемометров", isVisible: true, _pictureSet.BaseSettings1ButCollection[10], SActivePageState.TmhSettingsPage, id: 11, startAddress: ETH_THM_SETTINGS_ADDR);
            StartMenuCollection.Add(mItem);
            mItem = new MItem("Настройка Modbus шагового мотора", isVisible: true, _pictureSet.BaseSettings1ButCollection[11], SActivePageState.MBRecupSettingsPage, id: 12, startAddress: ETH_MBRECUP_SETTINGS_ADDR);
            StartMenuCollection.Add(mItem);
            mItem = new MItem("Настройки спец режима", isVisible: true, _pictureSet.BaseSettings1ButCollection[12], SActivePageState.SpecModeSettingsPage, id: 13, startAddress: ETH_SPECMODE_SETTINGS_ADDR);
            StartMenuCollection.Add(mItem);
            ...
            sSet = new StrSet(_fbEntities.CCommonSetPoints.SPTempAlarm.Min, _fbEntities.CCommonSetPoints.SPTempAlarm.Max, "Уставка аварийной темп, °C", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true, valScale: _fbEntities.CCommonSetPoints.SPTempAlarm.NumChr, pickVals);
            strSets.Add(sSet);
            sSet = new StrSet(0, 1, "Регулирование темп. по", isVisible: true, pickerIsVisible: true, entryIsVisible: false, isEnabled: true, valScale: 0, pickVals, false);
            strSets.Add(sSet);
            sSet = new StrSet(_fbEntities.CCommonSetPoints.SPTempMaxCh.Min, _fbEntities.CCommonSetPoints.SPTempMaxCh.Max, "Уставка темп.кан.макс.,°C", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true, valScale: _fbEntities.CCommonSetPoints.SPTempMaxCh.NumChr, pickVals);
            strSets.Add(sSet);
            sSet = new StrSet(_fbEntities.CCommonSetPoints.SPTempMinCh.Min, _fbEntities.CCommonSetPoints.SPTempMinCh.Max, "Уставка темп. кан. мин.,°C", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true, valScale: _fbEntities.CCommonSetPoints.SPTempMinCh.NumChr, pickVals);
            strSets.Add(sSet);
            sSet = new StrSet(0, 65535, "Задержка аварии по темп, сек", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true, valScale: 0, pickVals, false);
            strSets.Add(sSet);
            pickVals = new List<string>() { "Авто", "Зима", "Лето" };
            sSet = new StrSet(_fbEntities.CCommonSetPoints.SeasonMode.Min, _fbEntities.CCommonSetPoints.SeasonMode.Max, "Тип регулирования времени года", isVisible: true, pickerIsVisible: true, entryIsVisible: false, isEnabled: true, valScale: _fbEntities.CCommonSetPoints.SeasonMode.NumChr, pickVals);
            strSets.Add(sSet);
            sSet = new StrSet(_fbEntities.CCommonSetPoints.SPSeason.Min, _fbEntities.CCommonSetPoints.SPSeason.Max, "Темп. перехода зима/лето, °С", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true, valScale: _fbEntities.CCommonSetPoints.SPSeason.NumChr, pickVals);
            strSets.Add(sSet);
            sSet = new StrSet(_fbEntities.CCommonSetPoints.HystSeason.Min, _fbEntities.CCommonSetPoints.HystSeason.Max, "Гистерезис темп. перехода,°С", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true, valScale: _fbEntities.CCommonSetPoints.HystSeason.NumChr, pickVals);
            strSets.Add(sSet);
            pickVals = new List<string>() { "Откл", "Вкл" };
            sSet = new StrSet(0, 1, "Перезапуск по питанию", isVisible: true, pickerIsVisible: true, entryIsVisible: false, isEnabled: true, valScale: 0, pickVals);
            strSets.Add(sSet);
            sSet = new StrSet(0, 1, "Автосброс пожара", isVisible: true, pickerIsVisible: true, entryIsVisible: false, isEnabled: true, valScale: 0, pickVals);
            strSets.Add(sSet);
            sSet = new StrSet(_fbEntities.UFLeds.LEDsI.Min, _fbEntities.UFLeds.LEDsI.Max, "Сила тока УФ-светодиодов, А", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true, valScale: _fbEntities.UFLeds.LEDsI.NumChr, pickVals);
            strSets.Add(sSet);
            ...
            strSets.Add(sSet);
            sSet = new StrSet(0, 100, "Верхняя граница запрета, %", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true, valScale: 0, pickVals, false);
            strSets.Add(sSet);
            sSet = new StrSet(0, 65000, "Задержка контроля давления, сек", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true, valScale: 0, pickVals, false);
            strSets.Add(sSet);
            sSet = new StrSet(0, 65000, "Задержка контроля аварии вентилятора, сек", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true, valScale: 0, pickVals, false);
            strSets.Add(sSet);
            sSet = new StrSet(0, 1, "Функция снижения оборотов", isVisible: true, pickerIsVisible: true, entryIsVisible: false, isEnabled: true, valScale: 0, pickVals, false);
            strSets.Add(sSet);
            sSet = new StrSet(0, 1000, "P коэф. регулятора", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true, valScale: 0, pickVals, false);
            strSets.Add(sSet);
            ...
            strSets = new ObservableCollection<StrSet>();
            pickVals = new List<string>() { "Откл", "Вкл" };
            sSet = new StrSet(0, PidMaxVal, "P коэф. регулятора (работа)", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true, valScale: 0, pickVals, false);
            strSets.Add(sSet);
            sSet = new StrSet(0, PidMaxVal, "I коэф. регулятора (работа)", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true, valScale: 0, pickVals, false);
            strSets.Add(sSet);
            sSet = new StrSet(0, PidMaxVal, "D коэф. регулятора (работа)", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true, valScale: 0, pickVals, false);
            strSets.Add(sSet);
            sSet = new StrSet(0, PidMaxVal, "P коэф. регулятора (огран)", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true, valScale: 0, pickVals, false);
            strSets.Add(sSet);
            sSet = new StrSet(0, PidMaxVal, "I коэф. регулятора (огран)", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true, valScale: 0, pickVals, false);
            strSets.Add(sSet);
            sSet = new StrSet(0, PidMaxVal, "D коэф. регулятора (огран)", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true, valScale: 0, pickVals, false);
            strSets.Add(sSet);
            sSet = new StrSet(0, 100, "Max. темп. обратной воды, °C", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true, valScale: 1, pickVals, false);
            strSets.Add(sSet);
            sSet = new StrSet(0, 100, "Min. темп. обратной воды, °C", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true, valScale: 1, pickVals, false);
            strSets.Add(sSet);
            sSet = new StrSet(0, 100, "Дежурная темп. обратной воды, °C", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true, valScale: 1, pickVals, false);
            strSets.Add(sSet);
            sSet = new StrSet(0, 100, "Авар. темп. обратной воды, °C", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true, valScale: 1, pickVals, false);
            strSets.Add(sSet);
            sSet = new StrSet(0, 100, "Пусковая темп. обратной воды, °C", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true, valScale: 1, pickVals, false);
            strSets.Add(sSet);
            // не отображаем, потом потом удалить
            sSet = new StrSet(0, 100, "Пусковая темп. обратной воды2, °C", isVisible: false, pickerIsVisible: false, entryIsVisible: false, isEnabled: true, valScale: 1, pickVals, false);
            strSets.Add(sSet);
            sSet = new StrSet(0, 65_000, "Время мягкого пуска, сек", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true, valScale: 0, pickVals, false);
            strSets.Add(sSet);
            ...
            strSets = new ObservableCollection<StrSet>();
            pickVals = new List<string>() { "Откл", "Вкл" };
            sSet = new StrSet(0, 65535, "Мощность нагревателя, Вт", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true, valScale: 0, pickVals, false);
            strSets.Add(sSet);
            ...
            strSets.Add(sSet);
            sSet = new StrSet(0, 65535, "Время продувки, сек", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true, valScale: 0, pickVals, false);
            strSets.Add(sSet);
            ...
            sSet = new StrSet(0, PidMaxVal, "D коэф. регулятора", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true, valScale: 0, pickVals, false);
            strSets.Add(sSet);
            sSet = new StrSet(0, 65535, "Задержка включения ступени, сек", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true, valScale: 0, pickVals, false);
            strSets.Add(sSet);
            sSet = new StrSet(0, 65535, "Минимальное время работы ступени, сек", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true, valScale: 0, pickVals, false);
            strSets.Add(sSet);
            sSet = new StrSet(0, PidMaxVal, "Гистерезис вкл/выкл фреонового охладителя", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true, valScale: 0, pickVals, false);
            strSets.Add(sSet);
            ...
            strSets.Add(sSet);
            sSet = new StrSet(0, 65535, "Задержка контроля КПД, мин", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true, valScale: 0, pickVals, false);
            strSets.Add(sSet);
            sSet = new StrSet(0, 100, "Максимальная частота, Гц", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true, valScale: 0, pickVals, false);
            strSets.Add(sSet);
            sSet = new StrSet(_fbEntities.CRecup.TempA.Min, _fbEntities.CRecup.TempA.Max, "Температура А, °С", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true, valScale: _fbEntities.CRecup.TempA.NumChr, pickVals, false);
            strSets.Add(sSet);
            sSet = new StrSet(_fbEntities.CRecup.TempB.Min, _fbEntities.CRecup.TempB.Max, "Температура В, °С", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true, valScale: _fbEntities.CRecup.TempB.NumChr, pickVals, false);
            strSets.Add(sSet);
            ...
            sSet = new StrSet(0, 65535, "Минимальное. время работы ступени, сек", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true, valScale: 0, pickVals, false);
            strSets.Add(sSet);
            sSet = new StrSet(0, PidMaxVal, "Гистерезис вкл/выкл увлажнителя", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true, valScale: 0, pickVals, false);
            strSets.Add(sSet);
            ...
            strSets.Add(sSet);
            sSet = new StrSet(_fbEntities.ThmSps.SupDeltaTime.Min, _fbEntities.ThmSps.SupDeltaTime.Max, "Время охл притока", isVisible: true, pickerIsVisible: false, entryIsVisible: true,
             isEnabled: false, valScale: _fbEntities.ThmSps.SupDeltaTime.NumChr, pickVals);
            strSets.Add(sSet);
            sSet = new StrSet(_fbEntities.ThmSps.EDeltaTime.Min, _fbEntities.ThmSps.EDeltaTime.Max, "Время охл вытяжки", isVisible: true, pickerIsVisible: false, entryIsVisible: true,
            isEnabled: false, valScale: _fbEntities.ThmSps.EDeltaTime.NumChr, pickVals);
            strSets.Add(sSet);
            sSet = new StrSet(_fbEntities.ThmSps.SupPTa.Min, _fbEntities.ThmSps.SupPTa.Max, "Мощность Та притока", isVisible: true, pickerIsVisible: false, entryIsVisible: true,
            isEnabled: false, valScale: _fbEntities.ThmSps.SupPTa.NumChr, pickVals);
            strSets.Add(sSet);
            ...
            sSet = new StrSet(0, 1, "Направление вращения 1", isVisible: true, pickerIsVisible: true, entryIsVisible: false, isEnabled: true, valScale: 0, pickVals, false);
            strSets.Add(sSet);
            pickVals = new List<string>() { "Пр часовой", "По часовой" };
            ...
            strSets.Add(sSet);
            sSet = new StrSet(0, 100, "Коэффициент редукции", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true, valScale: 1, pickVals, false);
            strSets.Add(sSet);
            sSet = new StrSet(0, 100, "Номин. обороты 1, об в мин.", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true, valScale: 0, pickVals, false);
            strSets.Add(sSet);
            sSet = new StrSet(0, 100, "Номин. обороты 2, об в мин.", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true, valScale: 0, pickVals, false);
            strSets.Add(sSet);
            sSet = new StrSet(-70, 70, "Темп для номинала 1, °С", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true, valScale: 1, pickVals, false);
            strSets.Add(sSet);
            sSet = new StrSet(-70, 70, "Темп для номинала 2, °С", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true, valScale: 1, pickVals, false);
            strSets.Add(sSet);
            sSet = new StrSet(0, 10_000, "Притирочный ток, мА", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true, valScale: 0, pickVals, false);
            strSets.Add(sSet);
            sSet = new StrSet(0, 100, "Притирочные обороты, об в мин.", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true, valScale: 0, pickVals, false);
            strSets.Add(sSet);
            ...
            #region Калибровка
            strSets = new ObservableCollection<StrSet>();
            pickVals = new List<string>() { "Нет", "Горячий Ta" };
            ...
            sSet = new StrSet(_fbEntities.SupCalibrateThm.DeltaHCalibratesLimits.Min, _fbEntities.SupCalibrateThm.DeltaHCalibratesLimits.Max,
                "Дельта t притока 0, c", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true,
                                                valScale: _fbEntities.SupCalibrateThm.DeltaHCalibratesLimits.NumChr, pickVals);
            strSets.Add(sSet);
            sSet = new StrSet(_fbEntities.SupCalibrateThm.DeltaHCalibratesLimits.Min, _fbEntities.SupCalibrateThm.DeltaHCalibratesLimits.Max,
                 "Дельта t притока 1, c", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true,
                                                valScale: _fbEntities.SupCalibrateThm.DeltaHCalibratesLimits.NumChr, pickVals);
            strSets.Add(sSet);
            sSet = new StrSet(_fbEntities.SupCalibrateThm.DeltaHCalibratesLimits.Min, _fbEntities.SupCalibrateThm.DeltaHCalibratesLimits.Max,
                "Дельта t притока 2, c", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true,
                                                valScale: _fbEntities.SupCalibrateThm.DeltaHCalibratesLimits.NumChr, pickVals);
            strSets.Add(sSet);
            sSet = new StrSet(_fbEntities.SupCalibrateThm.DeltaHCalibratesLimits.Min, _fbEntities.SupCalibrateThm.DeltaHCalibratesLimits.Max,
                 "Дельта t притока 3, c", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true,
                                                valScale: _fbEntities.SupCalibrateThm.DeltaHCalibratesLimits.NumChr, pickVals);
            strSets.Add(sSet);
            sSet = new StrSet(_fbEntities.SupCalibrateThm.DeltaHCalibratesLimits.Min, _fbEntities.SupCalibrateThm.DeltaHCalibratesLimits.Max,
                "Дельта t притока 4, c", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true,
                                                valScale: _fbEntities.SupCalibrateThm.DeltaHCalibratesLimits.NumChr, pickVals);
            strSets.Add(sSet);
            sSet = new StrSet(_fbEntities.SupCalibrateThm.DeltaHCalibratesLimits.Min, _fbEntities.SupCalibrateThm.DeltaHCalibratesLimits.Max,
                "Дельта t притока 5, c", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true,
                                                valScale: _fbEntities.SupCalibrateThm.DeltaHCalibratesLimits.NumChr, pickVals);
            strSets.Add(sSet);
            sSet = new StrSet(_fbEntities.SupCalibrateThm.DeltaHCalibratesLimits.Min, _fbEntities.SupCalibrateThm.DeltaHCalibratesLimits.Max,
                "Дельта t притока Max, c", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true,
                                    valScale: _fbEntities.SupCalibrateThm.DeltaHCalibratesLimits.NumChr, pickVals);
            strSets.Add(sSet);
            ...
            sSet = new StrSet(_fbEntities.ExhaustCalibrateThm.DeltaHCalibratesLimits.Min, _fbEntities.ExhaustCalibrateThm.DeltaHCalibratesLimits.Max,
                "Дельта t вытяжки 0, c", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true,
                                                valScale: _fbEntities.ExhaustCalibrateThm.DeltaHCalibratesLimits.NumChr, pickVals);
            strSets.Add(sSet);
            sSet = new StrSet(_fbEntities.ExhaustCalibrateThm.DeltaHCalibratesLimits.Min, _fbEntities.ExhaustCalibrateThm.DeltaHCalibratesLimits.Max,
                 "Дельта t вытяжки 1, c", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true,
                                                valScale: _fbEntities.ExhaustCalibrateThm.DeltaHCalibratesLimits.NumChr, pickVals);
            strSets.Add(sSet);
            sSet = new StrSet(_fbEntities.ExhaustCalibrateThm.DeltaHCalibratesLimits.Min, _fbEntities.ExhaustCalibrateThm.DeltaHCalibratesLimits.Max,
                "Дельта t вытяжки 2, c", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true,
                                                valScale: _fbEntities.ExhaustCalibrateThm.DeltaHCalibratesLimits.NumChr, pickVals);
            strSets.Add(sSet);
            sSet = new StrSet(_fbEntities.ExhaustCalibrateThm.DeltaHCalibratesLimits.Min, _fbEntities.ExhaustCalibrateThm.DeltaHCalibratesLimits.Max,
                 "Дельта t вытяжки 3, c", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true,
                                                valScale: _fbEntities.ExhaustCalibrateThm.DeltaHCalibratesLimits.NumChr, pickVals);
            strSets.Add(sSet);
            sSet = new StrSet(_fbEntities.ExhaustCalibrateThm.DeltaHCalibratesLimits.Min, _fbEntities.ExhaustCalibrateThm.DeltaHCalibratesLimits.Max,
                "Дельта t вытяжки 4, c", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true,
                                                valScale: _fbEntities.ExhaustCalibrateThm.DeltaHCalibratesLimits.NumChr, pickVals);
            strSets.Add(sSet);
            sSet = new StrSet(_fbEntities.ExhaustCalibrateThm.DeltaHCalibratesLimits.Min, _fbEntities.ExhaustCalibrateThm.DeltaHCalibratesLimits.Max,
                "Дельта t вытяжки 5, c", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true,
                                                valScale: _fbEntities.ExhaustCalibrateThm.DeltaHCalibratesLimits.NumChr, pickVals);
            strSets.Add(sSet);
            sSet = new StrSet(_fbEntities.ExhaustCalibrateThm.DeltaHCalibratesLimits.Min, _fbEntities.ExhaustCalibrateThm.DeltaHCalibratesLimits.Max,
                "Дельта t вытяжки Max, c", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true,
                                    valScale: _fbEntities.ExhaustCalibrateThm.DeltaHCalibratesLimits.NumChr, pickVals);
            strSets.Add(sSet);
            ...
            sSet = new StrSet(0, 100, "Поз серво 1 овр", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true,
             valScale: 0, pickVals, switchIsActive: true, startAddress: ETH_CONTROLLER_CHECK_ADDR + 4, switchIndex: 0);
            strSets.Add(sSet);
            ...
            valScale: 0, pickVals, switchIsActive: true, startAddress: ETH_CONTROLLER_CHECK_ADDR + 6, switchIndex: 1);
            strSets.Add(sSet);
            ...
            valScale: 0, pickVals, switchIsActive: true, startAddress: ETH_CONTROLLER_CHECK_ADDR + 8, switchIndex: 2);
            strSets.Add(sSet);
            ...
            valScale: 0, pickVals, switchIsActive: true, startAddress: ETH_CONTROLLER_CHECK_ADDR + 10, switchIndex: 3);
            strSets.Add(sSet);
            ...
            valScale: 0, pickVals, switchIsActive: true, startAddress: ETH_CONTROLLER_CHECK_ADDR + 12, switchIndex: 4);
            strSets.Add(sSet);
            ...
            valScale: 0, pickVals, switchIsActive: true, startAddress: ETH_CONTROLLER_CHECK_ADDR + 14, switchIndex: 5);
            strSets.Add(sSet);
           ...
           "Темп. улицы овр", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true,
                 valScale: _fbEntities.CSensors.OutdoorTemp.Value.NumChr, pickVals, switchIsActive: true, startAddress: ETH_CONTROLLER_CHECK_ADDR + 16, switchIndex: 6);
            strSets.Add(sSet);
           ...
           "Темп. канала овр", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true,
               valScale: _fbEntities.CSensors.SupTemp.Value.NumChr, pickVals, switchIsActive: true, startAddress: ETH_CONTROLLER_CHECK_ADDR + 18, switchIndex: 7);
            strSets.Add(sSet);
           ...
           "Темп. комнаты овр", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true,
            valScale: _fbEntities.CSensors.RoomTemp.Value.NumChr, pickVals, switchIsActive: true, startAddress: ETH_CONTROLLER_CHECK_ADDR + 20, switchIndex: 8);
            strSets.Add(sSet);
           ...
           "Темп. гор датч прит овр", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true,
            valScale: _fbEntities.CSensors.TempH1.Value.NumChr, pickVals, switchIsActive: true, startAddress: ETH_CONTROLLER_CHECK_ADDR + 22, switchIndex: 9);
            strSets.Add(sSet);
            sSet = new StrSet(_fbEntities.ThmSps.SupPTa.Min, _fbEntities.ThmSps.SupPTa.Max, "Мощн Та прит %", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: false,
           valScale: _fbEntities.ThmSps.SupPTa.NumChr, pickVals);
            strSets.Add(sSet);
            sSet = new StrSet(_fbEntities.ThmSps.SupPTa.Min, _fbEntities.ThmSps.SupPTa.Max, "Мощн Та прит % овр", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true,
             valScale: _fbEntities.ThmSps.SupPTa.NumChr, pickVals, switchIsActive: true, startAddress: ETH_CONTROLLER_CHECK_ADDR + 24, switchIndex: 10);
            strSets.Add(sSet);
          ...
          valScale: _fbEntities.CSensors.TempC1.Value.NumChr, pickVals, switchIsActive: true, startAddress: ETH_CONTROLLER_CHECK_ADDR + 26, switchIndex: 11);
            strSets.Add(sSet);
           ...
           "Темп. гор датч выт овр", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true,
            valScale: _fbEntities.CSensors.TempH2.Value.NumChr, pickVals, switchIsActive: true, startAddress: ETH_CONTROLLER_CHECK_ADDR + 28, switchIndex: 12);
            strSets.Add(sSet);
            sSet = new StrSet(_fbEntities.ThmSps.EPTa.Min, _fbEntities.ThmSps.EPTa.Max, "Мощн Та выт %", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: false,
            valScale: _fbEntities.ThmSps.EPTa.NumChr, pickVals);
            strSets.Add(sSet);
            sSet = new StrSet(_fbEntities.ThmSps.EPTa.Min, _fbEntities.ThmSps.EPTa.Max, "Мощн Та выт % овр", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true,
            valScale: _fbEntities.ThmSps.EPTa.NumChr, pickVals, switchIsActive: true, startAddress: ETH_CONTROLLER_CHECK_ADDR + 30, switchIndex: 13);
            strSets.Add(sSet);
           ...
           valScale: _fbEntities.CSensors.TempC2.Value.NumChr, pickVals, switchIsActive: true, startAddress: ETH_CONTROLLER_CHECK_ADDR + 32, switchIndex: 14);
            strSets.Add(sSet);
            ...
            valScale: _fbEntities.CSensors.ReturnTemp.Value.NumChr, pickVals, switchIsActive: true, startAddress: ETH_CONTROLLER_CHECK_ADDR + 34, switchIndex: 15);
            strSets.Add(sSet);
            sSet = new StrSet(0, 100, "Вент прит %", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: false,
            valScale: 0, pickVals);
            strSets.Add(sSet);
            sSet = new StrSet(0, 100, "Вент прит % овр", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true,
            valScale: 0, pickVals, switchIsActive: true, startAddress: ETH_CONTROLLER_CHECK_ADDR + 36, switchIndex: 16);
            strSets.Add(sSet);
            sSet = new StrSet(0, 100, "Вент выт %", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: false,
            valScale: 0, pickVals);
            strSets.Add(sSet);
            sSet = new StrSet(0, 100, "Вент выт % овр", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true,
            valScale: 0, pickVals, switchIsActive: true, startAddress: ETH_CONTROLLER_CHECK_ADDR + 38, switchIndex: 17);
            strSets.Add(sSet);
            sSet = new StrSet(0, 100, "Рекуператор %", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: false,
            valScale: 0, pickVals);
            strSets.Add(sSet);
            sSet = new StrSet(0, 100, "Рекуператор % овр", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true,
            valScale: 0, pickVals, switchIsActive: true, startAddress: ETH_CONTROLLER_CHECK_ADDR + 40, switchIndex: 18);
            strSets.Add(sSet);
            sSet = new StrSet(0, 100, "Эл нагреватель %", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: false,
            valScale: 0, pickVals);
            strSets.Add(sSet);
            sSet = new StrSet(0, 100, "Эл нагреватель % овр", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true,
            valScale: 0, pickVals, switchIsActive: true, startAddress: ETH_CONTROLLER_CHECK_ADDR + 42, switchIndex: 19);
            strSets.Add(sSet);
            sSet = new StrSet(0, 1, "DI 1", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: false,
            valScale: 0, pickVals);
            strSets.Add(sSet);
            sSet = new StrSet(0, 1, "DI 1 овр", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true,
             valScale: 0, pickVals, switchIsActive: true, startAddress: ETH_CONTROLLER_CHECK_ADDR + 44, switchIndex: 20);
            strSets.Add(sSet);
            sSet = new StrSet(0, 1, "DI 2", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: false,
            valScale: 0, pickVals);
            strSets.Add(sSet);
            sSet = new StrSet(0, 1, "DI 2 овр", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true,
            valScale: 0, pickVals, switchIsActive: true, startAddress: ETH_CONTROLLER_CHECK_ADDR + 46, switchIndex: 21);
            strSets.Add(sSet);
            sSet = new StrSet(0, 1, "DI термореле", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: false,
            valScale: 0, pickVals);
            strSets.Add(sSet);
            sSet = new StrSet(0, 1, "DI термореле овр", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true,
            valScale: 0, pickVals, switchIsActive: true, startAddress: ETH_CONTROLLER_CHECK_ADDR + 48, switchIndex: 22);
            strSets.Add(sSet);
            sSet = new StrSet(0, 1, "DOut1", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: false,
            valScale: 0, pickVals);
            strSets.Add(sSet);
            sSet = new StrSet(0, 1, "DOut1 овр", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true,
            valScale: 0, pickVals, switchIsActive: true, startAddress: ETH_CONTROLLER_CHECK_ADDR + 50, switchIndex: 23);
            strSets.Add(sSet);
            sSet = new StrSet(0, 1, "DOut2", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: false,
            valScale: 0, pickVals);
            strSets.Add(sSet);
            sSet = new StrSet(0, 1, "DOut2 овр", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true,
            valScale: 0, pickVals, switchIsActive: true, startAddress: ETH_CONTROLLER_CHECK_ADDR + 52, switchIndex: 24);
            strSets.Add(sSet);
            sSet = new StrSet(0, 10, "AI1,В", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: false,
            valScale: 1, pickVals);
            strSets.Add(sSet);
            sSet = new StrSet(0, 10, "AI1 овр,В", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true,
            valScale: 1, pickVals, switchIsActive: true, startAddress: ETH_CONTROLLER_CHECK_ADDR + 54, switchIndex: 25);
            strSets.Add(sSet);
            sSet = new StrSet(0, 10, "AI2,В", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: false,
            valScale: 1, pickVals);
            strSets.Add(sSet);
            sSet = new StrSet(0, 10, "AI2 овр,В", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true,
            valScale: 1, pickVals, switchIsActive: true, startAddress: ETH_CONTROLLER_CHECK_ADDR + 56, switchIndex: 26);
            strSets.Add(sSet);
            sSet = new StrSet(0, 10, "AI3,В", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: false,
            valScale: 1, pickVals);
            strSets.Add(sSet);
            sSet = new StrSet(0, 10, "AI3 овр,В", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true,
            valScale: 1, pickVals, switchIsActive: true, startAddress: ETH_CONTROLLER_CHECK_ADDR + 58, switchIndex: 27);
            strSets.Add(sSet);
            sSet = new StrSet(0, 10, "AI4,В", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: false,
            valScale: 1, pickVals);
            strSets.Add(sSet);
            sSet = new StrSet(0, 10, "AI4 овр,В", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true,
            valScale: 1, pickVals, switchIsActive: true, startAddress: ETH_CONTROLLER_CHECK_ADDR + 60, switchIndex: 28);
            strSets.Add(sSet);
            sSet = new StrSet(0, 10, "AOut1,В", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: false,
            valScale: 1, pickVals);
            strSets.Add(sSet);
            sSet = new StrSet(0, 10, "AOut1 овр,В", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true,
            valScale: 1, pickVals, switchIsActive: true, startAddress: ETH_CONTROLLER_CHECK_ADDR + 62, switchIndex: 29);
            strSets.Add(sSet);
            sSet = new StrSet(0, 10, "AOut2,В", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: false,
            valScale: 1, pickVals);
            strSets.Add(sSet);
            sSet = new StrSet(0, 10, "AOut2 овр,В", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true,
            valScale: 1, pickVals, switchIsActive: true, startAddress: ETH_CONTROLLER_CHECK_ADDR + 64, switchIndex: 30);
            strSets.Add(sSet);
            sSet = new StrSet(0, 1, "УФ лампа в работе", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: false,
            valScale: 0, pickVals);
            strSets.Add(sSet);
            sSet = new StrSet(0, 1, "УФ лампа в работе овр", isVisible: true, pickerIsVisible: false, entryIsVisible: true, isEnabled: true,
            valScale: 0, pickVals, switchIsActive: true, startAddress: ETH_CONTROLLER_CHECK_ADDR + 66, switchIndex: 31);
            strSets.Add(sSet);
