...
namespace Android_Silver.Entities.Visual.Menus
{
    public class MenusEntities : BindableBase
    {
        ...
        public MenusEntities()
        {
            ...
            strStes.Add(sSet);
            sSet = new StrSet(0, 10000, "Задержка контроля давл., сек", isVisible: true, pickerIsVisible: false, entryIsVisible: true, pickVals);
            strStes.Add(sSet);
            ...
            strStes.Add(sSet);
            MenusCollection[2].StrSetsCollection = strStes;
            #endregion
            #region WHHeater
            strStes = new ObservableCollection<StrSet>();
            pickVals = new List<string>() { "Откл", "Вкл" };
            sSet = new StrSet(0, 1, "P коэф. регулят. (работа)", isVisible: true, pickerIsVisible: false, entryIsVisible: true, pickVals);
            strStes.Add(sSet);
            sSet = new StrSet(0, 1, "I коэф. регулят. (работа)", isVisible: true, pickerIsVisible: false, entryIsVisible: true, pickVals);
            strStes.Add(sSet);
            sSet = new StrSet(0, 1, "D коэф. регулят. (работа)", isVisible: true, pickerIsVisible: false, entryIsVisible: true, pickVals);
            strStes.Add(sSet);
            sSet = new StrSet(0, 1, "P коэф. регулят. (огран)", isVisible: true, pickerIsVisible: false, entryIsVisible: true, pickVals);
            strStes.Add(sSet);
            sSet = new StrSet(0, 1, "I коэф. регулят. (огран)", isVisible: true, pickerIsVisible: false, entryIsVisible: true, pickVals);
            strStes.Add(sSet);
            sSet = new StrSet(0, 1, "D коэф. регулят. (огран)", isVisible: true, pickerIsVisible: false, entryIsVisible: true, pickVals);
            strStes.Add(sSet);
            sSet = new StrSet(0, 1, "Max. темп. обратки, °C", isVisible: true, pickerIsVisible: false, entryIsVisible: true, pickVals);
            strStes.Add(sSet);
            sSet = new StrSet(0, 1, "Min. темп. обратки, °C", isVisible: true, pickerIsVisible: false, entryIsVisible: true, pickVals);
            strStes.Add(sSet);
            sSet = new StrSet(0, 1, "Дежурн. темп. обратки, °C", isVisible: true, pickerIsVisible: false, entryIsVisible: true, pickVals);
            strStes.Add(sSet);
            sSet = new StrSet(0, 1, "Авар. темп. обратки, °C", isVisible: true, pickerIsVisible: false, entryIsVisible: true, pickVals);
            strStes.Add(sSet);
            sSet = new StrSet(0, 1, "Пусковая темп. обратки, °C", isVisible: true, pickerIsVisible: false, entryIsVisible: true, pickVals);
            strStes.Add(sSet);
            sSet = new StrSet(0, 1, "Время мягкого пуска, сек", isVisible: true, pickerIsVisible: false, entryIsVisible: true, pickVals);
            strStes.Add(sSet);
            sSet = new StrSet(0, 1, "Минимальный % КЗР", isVisible: true, pickerIsVisible: false, entryIsVisible: true, pickVals);
            strStes.Add(sSet);
            sSet = new StrSet(0, 1, "Темп. 'зимних процедур'", isVisible: true, pickerIsVisible: false, entryIsVisible: true, pickVals);
            strStes.Add(sSet);
            sSet = new StrSet(0, 1, "Проба насоса летом", isVisible: true, pickerIsVisible: true, entryIsVisible: false, pickVals);
            strStes.Add(sSet);
            MenusCollection[3].StrSetsCollection = strStes;
            #endregion
            #region EHHeater
            strStes = new ObservableCollection<StrSet>();
            pickVals = new List<string>() { "Откл", "Вкл" };
            ...
            strStes.Add(sSet);
            MenusCollection[4].StrSetsCollection = strStes;
            #endregion
            #region FreonCooler
            strStes = new ObservableCollection<StrSet>();
            pickVals = new List<string>() { "Откл", "Вкл" };
            ...
            strStes.Add(sSet);
            MenusCollection[5].StrSetsCollection = strStes;
            #endregion
            #region Recup
            strStes = new ObservableCollection<StrSet>();
            pickVals = new List<string>() { "Откл", "Вкл" };
            ...
            strStes.Add(sSet);
            MenusCollection[6].StrSetsCollection = strStes;
            #endregion
            #region Hum
            strStes = new ObservableCollection<StrSet>();
            pickVals = new List<string>() { "Откл", "Вкл" };
            ...
            sSet = new StrSet(0, 10000, "Миним. время работы ступени, сек", isVisible: true, pickerIsVisible: false, entryIsVisible: true, pickVals);
            strStes.Add(sSet);
            MenusCollection[7].StrSetsCollection = strStes;
            #endregion
            #region Sensors
            strStes = new ObservableCollection<StrSet>();
            ...
            strStes.Add(sSet);
            MenusCollection[8].StrSetsCollection = strStes;
            #endregion
        }
