                ...
                case SActivePageState.ControllerCheckPage:
                    {
                        ...
                        //_menusEntities.StartMenuCollection[15].StrSetsCollection[1].CVal = _fbs.CControllerCheck.Servo1Pos.Value;
                        //_menusEntities.StartMenuCollection[15].StrSetsCollection[2].CVal = _fbs.CDamperSetPoints.ServoDampers[1].CAngle;
                        //_menusEntities.StartMenuCollection[15].StrSetsCollection[3].CVal = _fbs.CControllerCheck.Servo2Pos.Value;
                        //_menusEntities.StartMenuCollection[15].StrSetsCollection[4].CVal = _fbs.CDamperSetPoints.ServoDampers[2].CAngle;
                        //_menusEntities.StartMenuCollection[15].StrSetsCollection[5].CVal = _fbs.CControllerCheck.Servo3Pos.Value;
                        //_menusEntities.StartMenuCollection[15].StrSetsCollection[6].CVal = _fbs.CDamperSetPoints.ServoDampers[3].CAngle;
                        //_menusEntities.StartMenuCollection[15].StrSetsCollection[7].CVal = _fbs.CControllerCheck.Servo4Pos.Value;
                        //_menusEntities.StartMenuCollection[15].StrSetsCollection[4].CVal = _fbs.CSensors.OutdoorTemp.Value.Value;
                        //_menusEntities.StartMenuCollection[15].StrSetsCollection[5].CVal = _fbs.CSensors.SupTemp.Value.Value;
                        //_menusEntities.StartMenuCollection[15].StrSetsCollection[6].CVal = _fbs.CSensors.RoomTemp.Value.Value;
                        //_menusEntities.StartMenuCollection[15].StrSetsCollection[7].CVal = _fbs.CSensors.TempH1.Value.Value;
                        //_menusEntities.StartMenuCollection[15].StrSetsCollection[8].CVal = _fbs.CSensors.TempC1.Value.Value;
                        //_menusEntities.StartMenuCollection[15].StrSetsCollection[9].CVal = _fbs.CSensors.TempH2.Value.Value;
                        //_menusEntities.StartMenuCollection[15].StrSetsCollection[10].CVal = _fbs.CSensors.TempC2.Value.Value;
                        //_menusEntities.StartMenuCollection[15].StrSetsCollection[11].CVal = _fbs.CSensors.ReturnTemp.Value.Value;
