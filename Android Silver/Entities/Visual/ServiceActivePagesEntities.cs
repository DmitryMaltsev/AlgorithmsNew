    ...
    public class ServiceActivePagesEntities : BindableBase
    {
        ...
        public bool IsThmHSettingsPage
        {
            ...
            set
            {
                ...
                OnPropertyChanged(nameof(_isThmHSettingsPage));
            }
        }
                ...
                case (SActivePageState.ThmCalibratePage):
                    {
                        ...
                        _menusEntities.StartMenuCollection[13].StrSetsCollection[8].CVal = _fbs.SupCalibrateThm.CalibrateStepPercs[1];
                        _menusEntities.StartMenuCollection[13].StrSetsCollection[9].CVal = _fbs.SupCalibrateThm.CalibrateStepPercs[2];
                        _menusEntities.StartMenuCollection[13].StrSetsCollection[10].CVal = _fbs.SupCalibrateThm.CalibrateStepPercs[3];
                        _menusEntities.StartMenuCollection[13].StrSetsCollection[11].CVal = _fbs.SupCalibrateThm.CalibrateStepPercs[4];
                        _menusEntities.StartMenuCollection[13].StrSetsCollection[12].CVal = _fbs.SupCalibrateThm.CalibrateStepPercs[5];

                        _menusEntities.StartMenuCollection[13].StrSetsCollection[13].CVal = _fbs.SupCalibrateThm.DeltaHCalibrates[0];
                        _menusEntities.StartMenuCollection[13].StrSetsCollection[14].CVal = _fbs.SupCalibrateThm.DeltaHCalibrates[1];
                        _menusEntities.StartMenuCollection[13].StrSetsCollection[15].CVal = _fbs.SupCalibrateThm.DeltaHCalibrates[2];
                        _menusEntities.StartMenuCollection[13].StrSetsCollection[16].CVal = _fbs.SupCalibrateThm.DeltaHCalibrates[3];
                        _menusEntities.StartMenuCollection[13].StrSetsCollection[17].CVal = _fbs.SupCalibrateThm.DeltaHCalibrates[4];
                        _menusEntities.StartMenuCollection[13].StrSetsCollection[18].CVal = _fbs.SupCalibrateThm.DeltaHCalibrates[5];
                        _menusEntities.StartMenuCollection[13].StrSetsCollection[19].CVal = _fbs.SupCalibrateThm.DeltaHCalibrates[6];

                        _menusEntities.StartMenuCollection[13].StrSetsCollection[20].CVal = _fbs.SupCalibrateThm.FlowCalibrates[0];
                        _menusEntities.StartMenuCollection[13].StrSetsCollection[21].CVal = _fbs.SupCalibrateThm.FlowCalibrates[1];
                        _menusEntities.StartMenuCollection[13].StrSetsCollection[22].CVal = _fbs.SupCalibrateThm.FlowCalibrates[2];
                        _menusEntities.StartMenuCollection[13].StrSetsCollection[23].CVal = _fbs.SupCalibrateThm.FlowCalibrates[3];
                        _menusEntities.StartMenuCollection[13].StrSetsCollection[24].CVal = _fbs.SupCalibrateThm.FlowCalibrates[4];
                        _menusEntities.StartMenuCollection[13].StrSetsCollection[25].CVal = _fbs.SupCalibrateThm.FlowCalibrates[5];
                        _menusEntities.StartMenuCollection[13].StrSetsCollection[26].CVal = _fbs.SupCalibrateThm.FlowCalibrates[6];

                        _menusEntities.StartMenuCollection[13].StrSetsCollection[27].CVal = _fbs.ExhaustCalibrateThm.DeltaHCalibrates[0];
                        _menusEntities.StartMenuCollection[13].StrSetsCollection[28].CVal = _fbs.ExhaustCalibrateThm.DeltaHCalibrates[1];
                        _menusEntities.StartMenuCollection[13].StrSetsCollection[29].CVal = _fbs.ExhaustCalibrateThm.DeltaHCalibrates[2];
                        _menusEntities.StartMenuCollection[13].StrSetsCollection[30].CVal = _fbs.ExhaustCalibrateThm.DeltaHCalibrates[3];
                        _menusEntities.StartMenuCollection[13].StrSetsCollection[31].CVal = _fbs.ExhaustCalibrateThm.DeltaHCalibrates[4];
                        _menusEntities.StartMenuCollection[13].StrSetsCollection[32].CVal = _fbs.ExhaustCalibrateThm.DeltaHCalibrates[5];
                        _menusEntities.StartMenuCollection[13].StrSetsCollection[33].CVal = _fbs.ExhaustCalibrateThm.DeltaHCalibrates[6];

                        _menusEntities.StartMenuCollection[13].StrSetsCollection[34].CVal = _fbs.ExhaustCalibrateThm.FlowCalibrates[0];
                        _menusEntities.StartMenuCollection[13].StrSetsCollection[35].CVal = _fbs.ExhaustCalibrateThm.FlowCalibrates[1];
                        _menusEntities.StartMenuCollection[13].StrSetsCollection[36].CVal = _fbs.ExhaustCalibrateThm.FlowCalibrates[2];
                        _menusEntities.StartMenuCollection[13].StrSetsCollection[37].CVal = _fbs.ExhaustCalibrateThm.FlowCalibrates[3];
                        _menusEntities.StartMenuCollection[13].StrSetsCollection[38].CVal = _fbs.ExhaustCalibrateThm.FlowCalibrates[4];
                        _menusEntities.StartMenuCollection[13].StrSetsCollection[39].CVal = _fbs.ExhaustCalibrateThm.FlowCalibrates[5];
                        _menusEntities.StartMenuCollection[13].StrSetsCollection[40].CVal = _fbs.ExhaustCalibrateThm.FlowCalibrates[6];
