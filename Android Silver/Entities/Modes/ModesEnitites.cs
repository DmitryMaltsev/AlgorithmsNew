...
namespace Android_Silver.Entities.Modes
{
    public class ModesEntities : BindableBase
    {
        ...
        public ModesEntities()
        {
            ...
            _cPicturesSet.SelectModesPics[i], _cPicturesSet.IconsPics[i], "settingsPage", 106 + i * 4, _cPicturesSet.MiniIconsPics[i]));
            }
            ...
            //Режим отпуска
            Mode2ValuesList.Add(new Mode2Values(2, 4, _cPicturesSet.ActiveMode2Pics[2], Mode1ValuesList[0], 138));
            //Режим  календаря
            Mode2ValuesList.Add(new Mode2Values(3, 8, _cPicturesSet.ActiveMode2Pics[3], Mode1ValuesList[0], 164));
            //Режим по контакту
