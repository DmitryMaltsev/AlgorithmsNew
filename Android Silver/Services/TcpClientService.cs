        ...
        private void GetValueByTag(Response resp)
        {
            ...
            if (resp.Tag == _menusEntities.ETH_RECUP_SETTINGS_ADDR + 7 || resp.Tag == _menusEntities.ETH_RECUP_SETTINGS_ADDR + 7 + _menusEntities.WriteOffset)
            {
                if (short.TryParse(resp.ValueString, out short val))
                {
                    ...
                    if (val >= -500 && val <= 500)
                    {
                        _fbs.CRecup.TempA.Value = (float)val / 10;
                    }
                }
                return;
            }
            if (resp.Tag == _menusEntities.ETH_RECUP_SETTINGS_ADDR + 8 || resp.Tag == _menusEntities.ETH_RECUP_SETTINGS_ADDR + 8 + _menusEntities.WriteOffset)
            {
                if (short.TryParse(resp.ValueString, out short val))
                {
                    ...
                    if (val >= -500 && val <= 500)
                    {
                        _fbs.CRecup.TempB.Value = (float)val / 10;
                    }
                }
                return;
            }
            if (resp.Tag == _menusEntities.ETH_RECUP_SETTINGS_ADDR + 9 || resp.Tag == _menusEntities.ETH_RECUP_SETTINGS_ADDR + 9 + _menusEntities.WriteOffset)
            {
                if (short.TryParse(resp.ValueString, out short val))
                {
                    ...
                    if (val >= -500 && val <= 500)
                    {
                        _fbs.CRecup.TempC.Value = (float)val / 10;
                    }
                }
                return;
            }
            if (resp.Tag == _menusEntities.ETH_RECUP_SETTINGS_ADDR + 10 || resp.Tag == _menusEntities.ETH_RECUP_SETTINGS_ADDR + 10 + _menusEntities.WriteOffset)
            {
                if (short.TryParse(resp.ValueString, out short val))
                {
                    ...
                    if (val >= -500 && val <= 500)
                    {
                        _fbs.CRecup.TempD.Value = (float)val / 10;
                    }
                }
                if (_servActivePageEntities.IsLoadingPage)
                {
            ...
            if (resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR || resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.CRecup.RecProfiles[0].I_Start))
                    {
                        _fbs.CRecup.RecProfiles[0].I_Start.Value = _fbs.CRecup.RecProfiles[0].I_Start.Value;
                    }
                }
                return;
            }
            if (resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 1 || resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 1 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.CRecup.RecProfiles[0].I_Cont))
                    {
                        _fbs.CRecup.RecProfiles[0].I_Cont.Value = _fbs.CRecup.RecProfiles[0].I_Cont.Value;
                    }
                }
                return;
            }
            if (resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 2 || resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 2 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.CRecup.RecProfiles[0].Kp))
                    {
                        _fbs.CRecup.RecProfiles[0].Kp.Value = _fbs.CRecup.RecProfiles[0].Kp.Value;
                    }
                }
                return;
            }
            if (resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 3 || resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 3 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.CRecup.RecProfiles[0].Ki))
                    {
                        _fbs.CRecup.RecProfiles[0].Ki.Value = _fbs.CRecup.RecProfiles[0].Ki.Value;
                    }
                }
                return;
            }
            ...
            if (resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 4 || resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 4 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.CRecup.RecProfiles[1].I_Start))
                    {
                        _fbs.CRecup.RecProfiles[1].I_Start.Value = _fbs.CRecup.RecProfiles[1].I_Start.Value;
                    }
                }
                return;
            }
            if (resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 5 || resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 5 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.CRecup.RecProfiles[1].I_Cont))
                    {
                        _fbs.CRecup.RecProfiles[1].I_Cont.Value = _fbs.CRecup.RecProfiles[1].I_Cont.Value;
                    }
                }
                return;
            }
            if (resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 6 || resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 6 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.CRecup.RecProfiles[1].Kp))
                    {
                        _fbs.CRecup.RecProfiles[1].Kp.Value = _fbs.CRecup.RecProfiles[1].Kp.Value;
                    }
                }
                return;
            }
            if (resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 7 || resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 7 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.CRecup.RecProfiles[1].Ki))
                    {
                        _fbs.CRecup.RecProfiles[1].Ki.Value = _fbs.CRecup.RecProfiles[1].Ki.Value;
                    }
                }
                return;
            }
            if (resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 8 || resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 8 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.CRecup.RecProfiles[2].I_Start))
                    {
                        _fbs.CRecup.RecProfiles[2].I_Start.Value = _fbs.CRecup.RecProfiles[2].I_Start.Value;
                    }
                }
                return;
            }
            if (resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 9 || resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 9 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.CRecup.RecProfiles[2].I_Cont))
                    {
                        _fbs.CRecup.RecProfiles[2].I_Cont.Value = _fbs.CRecup.RecProfiles[2].I_Cont.Value;
                    }
                }
                return;
            }
            if (resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 10 || resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 10 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.CRecup.RecProfiles[2].Kp))
                    {
                        _fbs.CRecup.RecProfiles[2].Kp.Value = _fbs.CRecup.RecProfiles[2].Kp.Value;
                    }
                }
                return;
            }
            if (resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 11 || resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 11 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.CRecup.RecProfiles[2].Ki))
                    {
                        _fbs.CRecup.RecProfiles[2].Ki.Value = _fbs.CRecup.RecProfiles[2].Ki.Value;
                    }
                }
                return;
            }
            if (resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 12 || resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 12 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.CRecup.RecProfiles[3].I_Start))
                    {
                        _fbs.CRecup.RecProfiles[3].I_Start.Value = _fbs.CRecup.RecProfiles[3].I_Start.Value;
                    }
                }
                return;
            }
            if (resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 13 || resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 13 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.CRecup.RecProfiles[3].I_Cont))
                    {
                        _fbs.CRecup.RecProfiles[3].I_Cont.Value = _fbs.CRecup.RecProfiles[3].I_Cont.Value;
                    }
                }
                return;
            }
            if (resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 14 || resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 14 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.CRecup.RecProfiles[3].Kp))
                    {
                        _fbs.CRecup.RecProfiles[3].Kp.Value = _fbs.CRecup.RecProfiles[3].Kp.Value;
                    }
                }
                return;
            }
            if (resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 15 || resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 15 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.CRecup.RecProfiles[3].Ki))
                    {
                        _fbs.CRecup.RecProfiles[3].Ki.Value = _fbs.CRecup.RecProfiles[3].Ki.Value;
                    }
                }
                return;
            }
            ...
            if (resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 16 || resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 16 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.CRecup.RecProfiles[4].I_Start))
                    {
                        _fbs.CRecup.RecProfiles[4].I_Start.Value = _fbs.CRecup.RecProfiles[4].I_Start.Value;
                    }
                }
                return;
            }
            if (resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 17 || resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 17 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.CRecup.RecProfiles[4].I_Cont))
                    {
                        _fbs.CRecup.RecProfiles[4].I_Cont.Value = _fbs.CRecup.RecProfiles[4].I_Cont.Value;
                    }
                }
                return;
            }
            if (resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 18 || resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 18 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.CRecup.RecProfiles[4].Kp))
                    {
                        _fbs.CRecup.RecProfiles[4].Kp.Value = _fbs.CRecup.RecProfiles[4].Kp.Value;
                    }
                }
                return;
            }
            if (resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 19 || resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 19 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.CRecup.RecProfiles[4].Ki))
                    {
                        _fbs.CRecup.RecProfiles[4].Ki.Value = _fbs.CRecup.RecProfiles[4].Ki.Value;
                    }
                }
                return;
            }
            if (resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 20 || resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 20 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.CRecup.RecProfiles[5].I_Start))
                    {
                        _fbs.CRecup.RecProfiles[5].I_Start.Value = _fbs.CRecup.RecProfiles[5].I_Start.Value;
                    }
                }
                return;
            }
            if (resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 21 || resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 21 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.CRecup.RecProfiles[5].I_Cont))
                    {
                        _fbs.CRecup.RecProfiles[5].I_Cont.Value = _fbs.CRecup.RecProfiles[5].I_Cont.Value;
                    }
                }
                return;
            }
            if (resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 22 || resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 22 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.CRecup.RecProfiles[5].Kp))
                    {
                        _fbs.CRecup.RecProfiles[5].Kp.Value = _fbs.CRecup.RecProfiles[5].Kp.Value;
                    }
                }
                return;
            }
            if (resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 23 || resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 23 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.CRecup.RecProfiles[5].Ki))
                    {
                        _fbs.CRecup.RecProfiles[5].Ki.Value = _fbs.CRecup.RecProfiles[5].Ki.Value;
                    }
                }
                return;
            }
            if (resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 24 || resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 24 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.CRecup.RecProfiles[6].I_Start))
                    {
                        _fbs.CRecup.RecProfiles[6].I_Start.Value = _fbs.CRecup.RecProfiles[6].I_Start.Value;
                    }
                }
                return;
            }
            if (resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 25 || resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 25 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.CRecup.RecProfiles[6].I_Cont))
                    {
                        _fbs.CRecup.RecProfiles[6].I_Cont.Value = _fbs.CRecup.RecProfiles[6].I_Cont.Value;
                    }
                }
                return;
            }
            if (resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 26 || resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 26 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.CRecup.RecProfiles[6].Kp))
                    {
                        _fbs.CRecup.RecProfiles[6].Kp.Value = _fbs.CRecup.RecProfiles[6].Kp.Value;
                    }
                }
                return;
            }
            if (resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 27 || resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 27 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.CRecup.RecProfiles[6].Ki))
                    {
                        _fbs.CRecup.RecProfiles[6].Ki.Value = _fbs.CRecup.RecProfiles[6].Ki.Value;
                    }
                }
                return;
            }
            if (resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 28 || resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 28 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.CRecup.RecProfiles[7].I_Start))
                    {
                        _fbs.CRecup.RecProfiles[7].I_Start.Value = _fbs.CRecup.RecProfiles[7].I_Start.Value;
                    }
                }
                return;
            }
            if (resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 29 || resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 29 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.CRecup.RecProfiles[7].I_Cont))
                    {
                        _fbs.CRecup.RecProfiles[7].I_Cont.Value = _fbs.CRecup.RecProfiles[7].I_Cont.Value;
                    }
                }
                return;
            }
            if (resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 30 || resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 30 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.CRecup.RecProfiles[7].Kp))
                    {
                        _fbs.CRecup.RecProfiles[7].Kp.Value = _fbs.CRecup.RecProfiles[7].Kp.Value;
                    }
                }
                return;
            }
            if (resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 31 || resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 31 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.CRecup.RecProfiles[7].Ki))
                    {
                        _fbs.CRecup.RecProfiles[7].Ki.Value = _fbs.CRecup.RecProfiles[7].Ki.Value;
                    }
                }
                return;
            }
            if (resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 32 || resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 32 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.CRecup.RecProfiles[8].I_Start))
                    {
                        _fbs.CRecup.RecProfiles[8].I_Start.Value = _fbs.CRecup.RecProfiles[8].I_Start.Value;
                    }
                }
                return;
            }
            if (resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 33 || resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 33 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.CRecup.RecProfiles[8].I_Cont))
                    {
                        _fbs.CRecup.RecProfiles[8].I_Cont.Value = _fbs.CRecup.RecProfiles[8].I_Cont.Value;
                    }
                }
                return;
            }
            if (resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 34 || resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 34 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.CRecup.RecProfiles[8].Kp))
                    {
                        _fbs.CRecup.RecProfiles[8].Kp.Value = _fbs.CRecup.RecProfiles[8].Kp.Value;
                    }
                }
                return;
            }
            if (resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 35 || resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 35 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.CRecup.RecProfiles[8].Ki))
                    {
                        _fbs.CRecup.RecProfiles[8].Ki.Value = _fbs.CRecup.RecProfiles[8].Ki.Value;
                    }
                }
                return;
            }
            if (resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 36 || resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 36 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.CRecup.RecProfiles[9].I_Start))
                    {
                        _fbs.CRecup.RecProfiles[9].I_Start.Value = _fbs.CRecup.RecProfiles[9].I_Start.Value;
                    }
                }
                return;
            }
            if (resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 37 || resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 37 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.CRecup.RecProfiles[9].I_Cont))
                    {
                        _fbs.CRecup.RecProfiles[9].I_Cont.Value = _fbs.CRecup.RecProfiles[9].I_Cont.Value;
                    }
                }
                return;
            }
            if (resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 38 || resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 38 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.CRecup.RecProfiles[9].Kp))
                    {
                        _fbs.CRecup.RecProfiles[9].Kp.Value = _fbs.CRecup.RecProfiles[9].Kp.Value;
                    }
                }
                return;
            }
            if (resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 39 || resp.Tag == _menusEntities.ETH_RECUP_CURRENTSETTINGS_ADDR + 39 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.CRecup.RecProfiles[9].Ki))
                    {
                        _fbs.CRecup.RecProfiles[9].Ki.Value = _fbs.CRecup.RecProfiles[9].Ki.Value;
                    }
                }
                if (_servActivePageEntities.IsLoadingPage)
                {
            ...
            if (resp.Tag == _menusEntities.ETH_THMH_SETTINGS_ADDR || resp.Tag == _menusEntities.ETH_THMH_SETTINGS_ADDR + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
            ...
            if (resp.Tag == _menusEntities.ETH_THMH_SETTINGS_ADDR + 1 || resp.Tag == _menusEntities.ETH_THMH_SETTINGS_ADDR + 1 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.SupCalibrateThm.DeltaHCalibratesLimits))
            ...
            if (resp.Tag == _menusEntities.ETH_THMH_SETTINGS_ADDR + 2 || resp.Tag == _menusEntities.ETH_THMH_SETTINGS_ADDR + 2 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.SupCalibrateThm.DeltaHCalibratesLimits))
            ...
            if (resp.Tag == _menusEntities.ETH_THMH_SETTINGS_ADDR + 3 || resp.Tag == _menusEntities.ETH_THMH_SETTINGS_ADDR + 3 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.SupCalibrateThm.DeltaHCalibratesLimits))
            ...
            if (resp.Tag == _menusEntities.ETH_THMH_SETTINGS_ADDR + 4 || resp.Tag == _menusEntities.ETH_THMH_SETTINGS_ADDR + 4 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.SupCalibrateThm.DeltaHCalibratesLimits))
            ...
            if (resp.Tag == _menusEntities.ETH_THMH_SETTINGS_ADDR + 5 || resp.Tag == _menusEntities.ETH_THMH_SETTINGS_ADDR + 5 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.SupCalibrateThm.DeltaHCalibratesLimits))
            ...
            if (resp.Tag == _menusEntities.ETH_THMH_SETTINGS_ADDR + 6 || resp.Tag == _menusEntities.ETH_THMH_SETTINGS_ADDR + 6 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.SupCalibrateThm.DeltaHCalibratesLimits))
            ...
            //Вытяжка
            if (resp.Tag == _menusEntities.ETH_THMH_SETTINGS_ADDR + 7 || resp.Tag == _menusEntities.ETH_THMH_SETTINGS_ADDR + 7 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
            ...
            if (resp.Tag == _menusEntities.ETH_THMH_SETTINGS_ADDR + 8 || resp.Tag == _menusEntities.ETH_THMH_SETTINGS_ADDR + 8 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.ExhaustCalibrateThm.DeltaHCalibratesLimits))
            ...
            if (resp.Tag == _menusEntities.ETH_THMH_SETTINGS_ADDR + 9 || resp.Tag == _menusEntities.ETH_THMH_SETTINGS_ADDR + 9 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.ExhaustCalibrateThm.DeltaHCalibratesLimits))
            ...
            if (resp.Tag == _menusEntities.ETH_THMH_SETTINGS_ADDR + 10 || resp.Tag == _menusEntities.ETH_THMH_SETTINGS_ADDR + 10 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.ExhaustCalibrateThm.DeltaHCalibratesLimits))
            ...
            if (resp.Tag == _menusEntities.ETH_THMH_SETTINGS_ADDR + 11 || resp.Tag == _menusEntities.ETH_THMH_SETTINGS_ADDR + 11 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.ExhaustCalibrateThm.DeltaHCalibratesLimits))
            ...
            if (resp.Tag == _menusEntities.ETH_THMH_SETTINGS_ADDR + 12 || resp.Tag == _menusEntities.ETH_THMH_SETTINGS_ADDR + 12 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.ExhaustCalibrateThm.DeltaHCalibratesLimits))
            ...
            if (resp.Tag == _menusEntities.ETH_THMH_SETTINGS_ADDR + 13 || resp.Tag == _menusEntities.ETH_THMH_SETTINGS_ADDR + 13 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetFloatValueResult(val, _fbs.ExhaustCalibrateThm.DeltaHCalibratesLimits))
            ...
            if (resp.Tag == _menusEntities.ETH_THMH_SETTINGS_ADDR + 14 || resp.Tag == _menusEntities.ETH_THMH_SETTINGS_ADDR + 14 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetIntValueResult(val, _fbs.SupCalibrateThm.HotTHmdelayS))
                    {
                        _fbs.ExhaustCalibrateThm.HotTHmdelayS.Value = _fbs.SupCalibrateThm.HotTHmdelayS.Value;
                    }
                }
                return;
            }
            if (resp.Tag == _menusEntities.ETH_THMH_SETTINGS_ADDR + 15 || resp.Tag == _menusEntities.ETH_THMH_SETTINGS_ADDR + 15 + _menusEntities.WriteOffset)
            {
                if (int.TryParse(resp.ValueString, out int val))
                {
                    if (GetIntValueResult(val, _fbs.SupCalibrateThm.ColdThmDelayS))
                    {
                        _fbs.ExhaustCalibrateThm.ColdThmDelayS.Value = _fbs.SupCalibrateThm.ColdThmDelayS.Value;
                    }
                }
